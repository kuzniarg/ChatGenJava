...
//"\n" +
//"— Dałabym mu inne imię. Nie należy nazywać zwierząt imionami z Pisma Świętego.\n" +
//"\n" +
...
//"\n" +
//"Młynarz poszedł do sypialni, wytrącony z równowagi tą uległością Lizy. To było najgorsze, czego mógł oczekiwać: musiał rozstrzygać sam, on jeden. A skoro Liza się nie sprzeciwiała, cóż odpowiedzieć teściowej? Potem weszłaby w dom obca dziewczyna: okropność!\n" +
//"\n" +
...
//"\n" +
//"Poza nimi rozległ się tupot szybkich kroków — to nadbiegał Janek w towarzystwie Hektora, biało i czarno nakrapianego legawca, który powitał młynarza, swego przyjaciela, dzikimi skokami.\n" +
//"\n" +
