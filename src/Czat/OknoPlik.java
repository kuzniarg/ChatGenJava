 ...
 *   images/Save16.gif
 */
public class OknoPlik extends JPanel
                             implements ActionListener {
    static private final String newline = "\n";
    JButton dodajPlikButton, saveButton;
    JTextArea log;
    JFileChooser fc;
    ...
    public void actionPerformed(ActionEvent e) {
            int returnVal = fc.showOpenDialog(OknoPlik.this);
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                File file = fc.getSelectedFile();
                //This is where a real application would open the file.
                log.append("Otwieranie pliku: " + file.getName() + "." + newline);
                try {
                    wczytajPlik(file);
    ...
    protected static ImageIcon createImageIcon(String path) {
        java.net.URL imgURL = OknoPlik.class.getResource(path);
        if (imgURL != null) {
